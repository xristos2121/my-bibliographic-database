        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-6 py-4 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        <div class="flex-1 min-w-0">
                            <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Children of {{ $category->name }}</h2>
                        </div>
                        <div class="flex gap-4">
                            <a href="{{ route('categories.index') }}" class="inline-flex items-center px-4 py-2 bg-white text-black rounded-md shadow">Back to Categories</a>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @endif
                    @if ($children->isEmpty())
                        <p class="text-center">No child categories found.</p>
                    @else
